...
const LoginRegisterForm = ({
  ...
  //         toast.success("Email verification link send your email", toastConfig);
  //       } catch (verifyError) {
  //         setIsLoading(false);
  //       }
  //       navigate("/login");
  ...
  //       } else {
  //         setIsLoading(false);
  //         toast.error("Please verify your email", toastConfig);
  //       }
  //       setIsLoading(false);
  //     } catch (loginError) {
  //       setIsLoading(false);
  //       console.log(loginError);
  //       const firebaseNotification = firebaseErrorEdit(loginError);
  //       toast.error(firebaseNotification, toastConfig);
  //     }
  //   }
  // };

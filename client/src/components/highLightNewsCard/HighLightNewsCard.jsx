...
const HighLightNewsCard = ({ singleCategoryNewsData }) => {
  ...
  return (
    <div className="border flex flex-col justify-between p-2 mb-4 rounded-sm ">
      <img
        className="mb-2 w-[270px] h-[140px] object-cover rounded-sm"
        src={image_url}
        alt=""
      />
      <Link
      ...
      <div
        className={`${
          category_name && "flex"
        } items-center justify-between gap-4 mt-4 border-t py-1`}>
